...
export default {
  data() {
    return {
      editorData: `<h1><strong><span style="font-size:26px">&nbsp;REPORT&nbsp;&nbsp;</span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSt5yD4nZYCoGw5E5ssxxm9ipwyugL7ng849VBz9PjWmw&amp;s" style="height:71px; width:120px" /></strong></h1>
