		  ...
		  axios.get('http://172.18.100.240:6060/dimensions')
			.then(response => {
			  ...
			  this.editorData = `
				...
				<p><span style="font-size:16px"><strong>&nbsp;Date:</strong>&nbsp;<strong>${additionalLabels.Date}</strong></span></p>
				<p><span style="font-size:16px"><strong>&nbsp;Quantity:</strong>&nbsp;<strong>${additionalLabels.Quantity}</strong></span></p>
				<table align="left" border="1" cellpadding="1" cellspacing="1" style="width:700px">
				  <tbody>
					<tr>
					  ...
					  <td style="text-align:center"><span style="font-size:16px"><strong>${additionalLabels.Inspection_Report_No}</strong></span></td>
					  <td style="text-align:center"><span style="font-size:16px"><strong>Group:</strong></span></td>
					  <td style="text-align:center"><span style="font-size:16px"><strong>${additionalLabels.Group}</strong></span></td>
					</tr>
					<tr>
					  ...
					  <td style="text-align:center"><span style="font-size:16px"><strong>${additionalLabels.Part_Name}</strong></span></td>
					</tr>
					<tr>
