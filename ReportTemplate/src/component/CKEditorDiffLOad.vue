<template>
	<div>
	  ...
	  <button @click="saveTemplate">Save Template as PDF</button>
	  <embed ref="pdfObject" :src="pdfUrl" type="application/pdf" width="100%" height="600px" />
	</div>
  </template>
  ...
  // Trigger print function to save as PDF
...
loadTemplate(event) {
  ...
  reader.onload = () => {
    ...
    this.$refs.pdfObject.data = this.pdfUrl;
  };
  reader.readAsDataURL(file);
}
