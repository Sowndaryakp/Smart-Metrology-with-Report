<template>
            ...
            <div class="leftNav">
              ...
              >
                ...
                <!-- <template v-slot:hint>
                              <span class="text-black">File is processed locally in your browser</span>
                          </template> -->
                <template v-slot:after>
                  <q-btn dense flat label="URL" @click="urlDialog = true" />
                </template>
              </q-file>
                <div class="q-pa-md q-gutter-sm" style="min-height: 55px;">
  ...
  export default {
    ...
    methods: {
      ...
      async handleSubmitData() {
        ...
        try {
          ...
          const response = await axios.post('http://172.18.100.240:8989/save-data/', dataToSend);
    ...
    console.log("All ENtities : ",uploadedFileContent )
    ...
    this.$refs.viewerPage.renderDxfFile(data); // Assuming a method called renderDxfFile exists in the ViewerPage component
      ...
      openPreviousFiles() {
    // Toggle the flag to show/hide the dialog/modal
    this.showPreviousFiles = !this.showPreviousFiles;
    this.removeDuplicateFilesByName();
    // Clear dxfUrl when closing the dialog/modal
    // if (!this.showPreviousFiles) {
    //   this.clearDxfUrl();
    // }
  },
  clearDxfUrl() {
