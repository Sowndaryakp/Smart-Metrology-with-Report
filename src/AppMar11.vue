  ...
  export default {
    ...
    methods: {
      ...
      part_name: item.part_name || '' // Assign empty string if undefined
          ...
          console.log("APP DATA TO SEND ALL", dataToSend);
          // Send the data to the backend endpoint using Axios
          const response = await axios.post('http://172.18.100.240:6767/save-data/', dataToSend);
    ...
    axios.get('http://172.18.100.240:6767/dxf_files/')
        .then(response => {
