  ...
  <div class="outer-card" >
    <div class="card-wrapper">
      ...
      <div class="row items-center">
        ...
        <button class="save-btn" style="background-color: rgb(10, 151, 17);margin-right: 11px;width:110px; display: flex; align-items: center; justify-content: center;" @click="downloadPDF">
          <img width="24" height="24" src="https://img.icons8.com/sf-black-filled/64/FFFFFF/save.png" alt="save"/>Save
        </button>
...
<script>
import DataTablePdf from './DataTablePdf.vue';
import jsPDF from 'jspdf';

export default {
  components: {
    DataTablePdf // Register DataTablePdf component
  },
  data() {
    return {
 ...
 methods: {
  ...
  // Get HTML content of DataTablePdf component
  const dataTablePdfContent = this.$refs.dataTablePdf.$el;

  // Log DataTablePdf content to console for debugging
  console.log("DataTablePdf content:", dataTablePdfContent);

  // Create a new page in the PDF document
  pdf.addPage();

  // Convert DataTablePdf component HTML to PDF
  pdf.html(dataTablePdfContent, {
    callback: () => {
      // Save PDF when conversion is complete
