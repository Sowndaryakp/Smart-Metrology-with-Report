  ...
  <div class="card-wrapper">
    ...
    <div class="custom-card">
      <div class="card-section">
        ...
        <div class="input-box">
          <!-- <input class="custom-input" outlined placeholder="Enter address" v-model="deviceAddress"/> -->
          <select class="custom-select" v-model="selectedDevice" @change="selectDevice">
            <option value="" disabled>Select device address</option>
            <option v-for="address in deviceAddresses" :value="address">{{ address }}</option>
          </select>
        </div>
      </div>
    </div>
    ...
    <div class="custom-card">
      <div class="card-section">
        ...
        <div class="input-box">
          <input class="custom-input" outlined placeholder="Enter Name" :value="deviceName" disabled/>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      deviceAddresses: ['Address 1', 'Address 2', 'Address 3'], // Sample device addresses
  ...
  methods: {
    selectDevice() {
      // Generate a random device name when a device address is selected
      const randomIndex = Math.floor(Math.random() * this.deviceAddresses.length);
      this.deviceName = this.deviceAddresses[randomIndex];
    },
  },
};
</script>
