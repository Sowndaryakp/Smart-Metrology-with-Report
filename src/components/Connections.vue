  ...
  <div class="outer-card" >
    <div class="card-wrapper">
      ...
      <div class="row items-center">
        ...
        <!-- <button @click="openReportPopup" class="btn">
      Report
    </button> -->
...
<!-- <button @click="downloadPDF" class="save-btn" style="background-color: rgb(10, 151, 17); margin-right: 11px; width: 110px; display: flex; align-items: center; justify-content: center;">
  <img width="24" height="24" src="https://img.icons8.com/sf-black-filled/64/FFFFFF/save.png" alt="save"/>Save
        ...
        <button @click="exportToExcel" class="export-btn" style="background-color: black;margin-right: 11px;width:250px; display: flex; align-items: center; justify-content: center;">
          <img width="24" height="24" src="https://img.icons8.com/sf-black/64/FFFFFF/export.png" alt="export"/>Export
        </button>
        <button @click="navigateToReportPage" class="export-btn" style="background-color: black;width:200px; display: flex; align-items: center; justify-content: center;">
          <img width="24" height="24" src="https://img.icons8.com/sf-black/64/FFFFFF/export.png" alt="export"/>Report
        </button>
      </div>
    </div>
    </div>
  ...
  <div v-if="showReportPopup" class="modal">
      <div class="modal-content">
        <PdfReport/>
        <button @click="closeReportPopup" class="close-btn">&times;</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  components: { PdfReport,ReportPage
  },
  data() {
    return {
 ...
 methods: {
  ...
  openReportPopup() {
    ...
    // Method to close the report popup
    closeReportPopup() {
...
.modal {
  ...
  left: 0;
  top: 0;
  width: 50%; /* Set width to cover half of the page */
  height: 80%; /* Cover the entire height of the page */
...
.modal-content {
  ...
  max-width: 80%; /* Set maximum width for the modal */
  max-height: 80%; /* Set maximum height for the modal */
  overflow: auto; /* Enable scrolling if content overflows */
